...
export const topics: Topic[] = [
  {
    ...
    color: "amber",
    insights: [
      { title: "פערי מקצועיות", body: "ל-62% ממנהלי מחלקות הנוער אין הכשרה פורמלית בתחום ההובלה החינוכית." },
      { title: "תחלופה גבוהה", body: "ממוצע משך הכהונה של רכזי נוער ברשות הוא 2.8 שנים — חצי מהממוצע במגזר הפרטי." },
  ...
  },
  {
    ...
    color: "coral",
    insights: [
      { title: "התרחבות הצורך", body: "84% מבני הנוער מבקשים מסגרות פנאי משמעותיות — בהנחה שזה לא חוג נוסף." },
      { title: "פערים גיאוגרפיים", body: "פער של פי 3 בהיצע פעילויות בלתי פורמליות בין מרכז לפריפריה." },
      { title: "השפעת השביעי באוקטובר", body: "67% מהרכזים מדווחים על שינוי בצרכים הרגשיים של בני הנוער מאז 7 באוקטובר." },
    ],
  ...
  },
  {
    ...
    color: "teal",
    insights: [
      { title: "AI Native", body: "73% מבני הנוער השתמשו ב-ChatGPT לבית הספר ב-2025 — לעומת 12% ב-2023." },
      { title: "פערים דיגיטליים", body: "אצל 23% מהמשפחות בפריפריה אין גישה למחשב אישי בבית — פי 4 מהמרכז." },
      { title: "בריאות נפשית", body: "מתאם של 0.41 בין שימוש כבד ברשתות חברתיות לבין מצוקה רגשית בקרב גילאי 13-15." },
    ],
  ...
  },
  {
    ...
    color: "moss",
    insights: [
      { title: "מודל הקבוצה", body: "רשויות שעברו לעבודה בקבוצות שותפים אזוריות הראו עלייה של 38% במדדי השפעה." },
      { title: "המגזר השלישי", body: "57% מהרשויות לא ממנפות מספיק את שיתוף הפעולה עם עמותות המגזר השלישי." },
      { title: "מימון משולב", body: "כל שותפות עירונית-עסקית מחזירה בממוצע ₪2.4 לכל שקל ציבורי שמושקע." },
    ],
...
// ============================================================
// NATIONAL YOUTH STATS
// ============================================================
export const stats: Stat[] = [
  { label: "בני נוער בישראל (12-18)", value: 940000, source: "הלמ״ס 2024" },
  { label: "רשויות מקומיות בישראל", value: 257, source: "משרד הפנים" },
  { label: "תנועות נוער פעילות", value: 14, source: "מנהל חברה ונוער" },
  { label: "שיעור השתתפות במסגרות נוער", value: 62, suffix: "%", source: "סקר שימוש בזמן 2023" },
  { label: "מתנדבי שירות אזרחי-לאומי שנתי", value: 18500, source: "מנהל השירות הלאומי" },
  { label: "תקציב מח׳ נוער ממוצע לרשות", value: 2.4, prefix: "₪", suffix: "מ׳", source: "משרד החינוך" },
];
