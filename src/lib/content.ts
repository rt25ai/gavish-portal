...
export const topics: Topic[] = [
  {
    ...
    description:
      "מנהלת מחלקת נוער מקבלת מאות החלטות בשנה - תקציב, תוכן, צוות, שותפים. אתגר השורש הוא מעבר משיקול דעת אינטואיטיבי לתשתית נתונים שתומכת בכל החלטה.",
    color: "teal",
    insights: [
...
export const timeline = [
  ...
  { date: "ינואר 2026", title: "צוותי המחקר", body: "המשתתפים נחלקו ל-4 צוותי אתגרי שורש, כל אחד חקר נושא לעומק." },
